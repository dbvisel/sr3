...
<Figure caption="Figure 1" img={"flask.png"} id="figure1" />
...
<Figure caption="Figure 2: Bowl and vase distribution" img={"bowlandvasedistro.png"} id="figure2" />

<Figure caption="Figure 3: Porcelain distribution" img={"porcelaindistro.png"} id="figure3" />
