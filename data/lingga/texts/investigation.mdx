...
<Figure number="4" caption="Shipwreck location between Sumatra and the Lingga Island group." />
...
<Figure number="5" caption="Initial site investigation by PT Cosmix Asia. There is clear evidence of looting." />

<Figure number="6" caption="A number of hull planks with carved lugs were recovered for documentation." />
...
<Figure number="7" caption="Dowels were used to edge-join the hull planks." />
...
<Figure number="8" caption="Stacks of bowls revealed under the centre-line rope after a layer of sand was removed by air-lifting." />

<Figure number="9" caption="Stacks of bowls and a vase recovered from beneath the sediment." />

<Figure number="10" caption="Stacks of folded-rim bowls stuck to an iron concretion." />